...
class Grid extends ArrayList<ArrayList<Cell>>
{
    ...
    static void generateMap(int plength, int pheight) //generate random map
    {
       length=plength;
       height=pheight;
    ...
    static void generateMapHardcode() //generates a hardcoded map used for testing
    {
        length=5;
        height=5;
    ...
    void initiateplayer() //initialise player on first cell
    {
    ...
    Cell generateShopCell(int x, int y) //generate shop
    {
        Cell c= new Cell();
        c.x=x;
        c.y=y;
    ...
    Cell generateEnemyCell(int x, int y) //generate enemy
    {
        Cell c= new Cell();
        c.x=x;
        c.y=y;
    ...
    Cell generateEmptyCell(int x, int y) //generate empty
    {
        Cell c= new Cell();
        c.x=x;
        c.y=y;
    ...
    Cell generateFinishCell(int x, int y) //generate finish
    {
        Cell c= new Cell();
        c.x=x;
        c.y=y;
    ...
    void showMap() //show map based on progress
    {
